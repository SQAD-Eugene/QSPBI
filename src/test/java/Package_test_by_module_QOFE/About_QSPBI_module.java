...
import Package_Element_QOFE.About_QSPBI_module_elements;
...
public class About_QSPBI_module {
    ...
    @Test(priority = 4, testName = "(About QSPBI) - Verify functionality of About QSPBI Tab")
    public void test_About_QSPBI_Tab(){
        About_QSPBI_module_elements about = new About_QSPBI_module_elements(driver);
        WebDriverWait eWait = new WebDriverWait(driver, Duration.ofSeconds(60));
        eWait.until(ExpectedConditions.visibilityOfAllElements(about.About_QSPBI_Tab));
        about.About_QSPBI_Tab.click();

    }

    @Test(priority = 5, testName = "(About QSPBI) - Verify Visibility of Overview Page")
    public void test_Overview_Page(){
        About_QSPBI_module_elements about = new About_QSPBI_module_elements(driver);
        WebDriverWait eWait = new WebDriverWait(driver, Duration.ofSeconds(60));
        eWait.until(ExpectedConditions.visibilityOfAllElements(about.Overview_QSPBI_dd));
        about.Overview_QSPBI_dd.click();
        softAssert.assertTrue(about.Overview_page.isDisplayed(),"Overview is not displayed");
    }

    @Test(priority = 6, testName = "(About QSPBI) - Verify Visibility of Concepts and Definitions Page")
    public void test_Concepts_and_Definitions_Page(){
        About_QSPBI_module_elements about = new About_QSPBI_module_elements(driver);
        WebDriverWait eWait = new WebDriverWait(driver, Duration.ofSeconds(60));
        eWait.until(ExpectedConditions.visibilityOfAllElements(about.About_QSPBI_Tab));
        about.About_QSPBI_Tab.click();

        eWait.until(ExpectedConditions.visibilityOfAllElements(about.Concept_definition_dd));
        about.Concept_definition_dd.click();
        softAssert.assertTrue(about.Concepts_Definitions_page.isDisplayed(),"Concept and Definition is not displayed");

    }

    @Test(priority = 7, testName = "(About QSPBI) - Verify Visibility of QNAP Release Page")
    public void test_QNAP_Page(){
        About_QSPBI_module_elements about = new About_QSPBI_module_elements(driver);
        WebDriverWait eWait = new WebDriverWait(driver, Duration.ofSeconds(60));
        eWait.until(ExpectedConditions.visibilityOfAllElements(about.About_QSPBI_Tab));
        about.About_QSPBI_Tab.click();

        eWait.until(ExpectedConditions.visibilityOfAllElements(about.QNAP_Release_dd));
        about.QNAP_Release_dd.click();
        softAssert.assertTrue(about.QNAP_page.isDisplayed(),"QNAP Release is not displayed");
